...
def resnet152(input_shape=(64, 64, 3), num_classes=10):
...
sns.heatmap(cm, annot=True, fmt='d', cmap='Purples', xticklabels=digits.target_names, yticklabels=digits.target_names)
plt.xlabel('Tahmin')
plt.ylabel('Doğruluk')
plt.show()